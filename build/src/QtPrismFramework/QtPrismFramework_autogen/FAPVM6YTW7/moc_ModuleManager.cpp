...
#include <memory>
#include "../../../../../src/QtPrismFramework/Modularity/ModuleManager.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_ModuleManager_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_ModuleManager_t qt_meta_stringdata_ModuleManager = {
    {
        QT_MOC_LITERAL(0, 13)   // "ModuleManager"
    },
    "ModuleManager"
};
...
Q_CONSTINIT static const uint qt_meta_data_ModuleManager[] = {
...
Q_CONSTINIT const QMetaObject ModuleManager::staticMetaObject = { {
    QMetaObject::SuperData::link<IModuleManager::staticMetaObject>(),
    qt_meta_stringdata_ModuleManager.offsetsAndSizes,
    qt_meta_data_ModuleManager,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_ModuleManager_t,
        // Q_OBJECT / Q_GADGET
...
void *ModuleManager::qt_metacast(const char *_clname)
{
    ...
    return IModuleManager::qt_metacast(_clname);
}

int ModuleManager::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = IModuleManager::qt_metacall(_c, _id, _a);
    return _id;
}
QT_WARNING_POP
